...
const GridTemplate = () => {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      containerRef.current.querySelector("a img"),
      { opacity: 0, scale: 0.9 },
      {
        opacity: 1,
        scale: 1,
      ...
      <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
        ...
        >
          <img
            src={img1}
            alt=""
            className="object-cover w-100 h-60 rounded sm:h-96 lg:col-span-7 dark:bg-black-500"
          />
          ...
          {items.map((item, index) => (
            ...
            >
              ...
              >
                <img
                  role="presentation"
                  className="object-fit w-full rounded h-40 dark:bg-gray-500"
                  src={item.image}
                  alt={item.title}
                />
              </a>
